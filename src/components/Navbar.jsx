      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            ...
            <Link
              to={isEnquiryPage ? '/contact' : '/enquiry'}
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-2xl font-semibold text-sm transition-all duration-200 active:scale-95 inline-flex items-center justify-center"
            >
              {isEnquiryPage ? 'Contact Us' : 'Enquiry'}
            </Link>
            ...
            <div className="flex flex-col gap-y-6 text-center text-lg font-medium">
              ...
              <div className="pt-4">
                ...
                <Link
                  to={isEnquiryPage ? '/contact' : '/enquiry'}
                  onClick={() => setIsMenuOpen(false)}
                  className="w-full bg-blue-600 text-white py-4 rounded-2xl font-semibold inline-flex items-center justify-center"
                >
                  {isEnquiryPage ? 'Contact Us' : 'Enquiry'}
                </Link>
